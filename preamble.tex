...
% \includeonly command on line 2 of main.tex. 
%
...
%   - Tested to work on Overleaf (as of February 2025)
...
\usepackage{multicol}                       % multicolumn text where appropriate, used in refs.
...
% NOTE FOR ADVANCED USERS:
\sisetup{detect-weight,detect-shape,mode=text}      % This uses the text font for numbers throughout, even if
                                                    % they're in equations. This means writing, say, $<\qty{0.5}{\metre}$
                                                    % in a sentence looks in keeping with the rest of the text.
...
%\sffamily
%
% Ensure that quantities in math mode use normal font by default. Makes things look neater
% You can always use [mode=math] to convert to math mode
